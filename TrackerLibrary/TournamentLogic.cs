...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        private static void AlertPersonToNewRound(PersonModel p, string teamName, MatchupEntryModel competitor)
        {
            ...
            recipientAddress = p.EmailAddress;
            recipientName = p.FullName;

            EmailLogic.SendEmail(sender, recipientAddress, recipientName, subject, body.ToString());
        }
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            body.AppendLine("<p>Congratulatuon to out winner on a great tournament.</p>");
            body.AppendLine("<br/>");
            ...
            foreach(TeamModel t in model.EnteredTeams)
            {
                foreach(PersonModel p in t.TeamMembers)
                {
                    if (p.EmailAddress.Length > 0)
                    {
                        EmailLogic.SendEmail(sender, p.EmailAddress, p.FullName, subject, body.ToString());
                    }
                }
            }
